...
class NaoTTSNode(Node):
    ...
    def query_gemini(self):
        ...
        Esempio di risposta: "Il braccio sinistro è troppo alto, abbassalo leggermente", "Il braccio destro è troppo basso, alzalo di molto", "Avvicina il braccio sinistro al corpo", "Allontana il braccio destro dal corpo", "Fletti completamente il gomito sinistro", "Chiudi il gomito destro".
        Evita di usare la parola "spalla" nelle tue risposte, usa sempre "braccio".
        Non usare asterischi o simboli speciali e rispondi in maniera naturale.
        ...
        print(prompt)
        response = model.generate_content(prompt, generation_config={"temperature":0, "max_output_tokens":100}, safety_settings={
    ...
    def load_poses(self, json_path="/home/sciarcan/nao_ws/src/user_input/user_input/poses.json"):
    ...
    def apply_pose(self, pose_id=None, pose_name=None):
        ...
        self.motion_service.setAngles(names, angles, 0.1)
